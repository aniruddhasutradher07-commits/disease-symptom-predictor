...
| Property         | Value |
| ---------------- | ----: |
| Total samples    | 2,194 (merged from Symptom2Disease + gretelai/symptom_to_diagnosis) |
| Disease classes  |    24 |
...
These files are committed to the repository so the deployed app works out of the box.
...
Try it here: [disease-symptom-predictor.onrender.com](https://disease-symptom-predictor.onrender.com)

> Hosted on Render's free tier — may take 30–60 seconds to wake up if inactive.
